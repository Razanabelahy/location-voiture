...
function Navbar() {
    ...
    return (
        <div id="navbar" className="bg-light-yellow flex justify-between items-center h-16 fixed top-0 w-full" >
            <nav id="navbar_links" className=" flex justify-center md:gap-x-32 lg:gap-x-44 items-center text-white list-none font-sans px-3">
                <li>
                    <Link
